...
using PoweredSoft.Docker.MongoBackup.Notifications.Slack;
using PoweredSoft.Docker.MongoBackup.Notifications.Teams;
using PoweredSoft.Docker.MongoBackup.Retention;
using PoweredSoft.Docker.MongoBackup.Storage.Azure;
using PoweredSoft.Docker.MongoBackup.Storage.Physical;
using PoweredSoft.Docker.MongoBackup.Storage.S3;
...
namespace PoweredSoft.Docker.MongoBackup
{
    ...
    public class Program
    {
        ...
        private static void AddConfigurationServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<MongoConfiguration>(ctx =>
            {
                var t = new MongoConfiguration();
                configuration.Bind("Mongo", t);
                return t;
            });
